classdef image_sub < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function UploadtheImagesButtonPushed(app, event)
            [fileName1, filePath1] = uigetfile({'*.jpg;*.jpeg;*.png', 'Image Files (*.jpg, *.jpeg, *.png)'}, 'Select an image file');
            fullFilePath1 = fullfile(filePath1, fileName1);
            imageData1 = imread(fullFilePath1);
            app.img1 = imageData1;
            % Display the image on the UI axis
            [fileName2, filePath2] = uigetfile({'*.jpg;*.jpeg;*.png', 'Image Files (*.jpg, *.jpeg, *.png)'}, 'Select an image file');
            if fileName2 == 0
                return;
            end
        ...
        function SubtractButtonPushed(app, event)
            desiredSize = [size(app.img1, 1), size(app.img1, 2)]; % Specify desired size
        ...
        function EXPORTButtonPushed(app, event)
            outputPath = 'C:\Users\achuj\Documents\_IMG_SUB\exported_image.jpg'; % Change the path and filename as needed
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.BRIGHTNESSKnob.ValueChangingFcn = createCallbackFcn(app, @BRIGHTNESSKnobValueChanging, true);
            ...
            app.CONTRASTKnob.ValueChangingFcn = createCallbackFcn(app, @CONTRASTKnobValueChanging, true);
            ...
            app.UploadtheImagesButton.ButtonPushedFcn = createCallbackFcn(app, @UploadtheImagesButtonPushed, true);
            ...
            app.StandardDeviationforGaussianFilterSliderLabel = uilabel(app.GridLayout2);
            app.StandardDeviationforGaussianFilterSliderLabel.HorizontalAlignment = 'right';
            ...
            app.StandardDeviationforGaussianFilterSliderLabel.Layout.Column = [2 3];
            app.StandardDeviationforGaussianFilterSliderLabel.Text = 'Standard Deviation for Gaussian Filter';

            % Create StandardDeviationforGaussianFilterSlider
            app.StandardDeviationforGaussianFilterSlider = uislider(app.GridLayout2);
            app.StandardDeviationforGaussianFilterSlider.Limits = [0 5];
            app.StandardDeviationforGaussianFilterSlider.ValueChangingFcn = createCallbackFcn(app, @StandardDeviationforGaussianFilterSliderValueChanging, true);
